...
enum Commands {
	...
	CMD_INDUSTRY_STEP_PRODUCTION,     ///< change production rates of an industry stepwise, or close it
	CMD_INDUSTRY_SET_PRODUCTION,      ///< change production rate of an industry to a specific level
