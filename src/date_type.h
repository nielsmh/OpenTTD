...
static const int DAYS_IN_ECONOMY_MONTH = 30;
static const int MONTHS_IN_ECONOMY_YEAR = 12;
static const int DAYS_IN_ECONOMY_YEAR = DAYS_IN_ECONOMY_MONTH * MONTHS_IN_ECONOMY_YEAR;
